(globalThis.TURBOPACK = globalThis.TURBOPACK || []).push(["static/chunks/src_5ecca6._.js", {
            ...
            const verifyEmail = {
                "VerifyEmailPage.useEffect.verifyEmail": async ()=>{
                    ...
                    try {
                        ...
                        const response = await fetch(`${("TURBOPACK compile-time value", "http://localhost:5000")}/api/auth/verify-email`, {
                            method: 'POST',
                            headers: {
...
_s(VerifyEmailPage, "1NdBkCfagK5BLFOQr6tVHfoG3LM=", false, function() {
    return [
...
"[project]/src/app/auth/verify-email/page.tsx [app-rsc] (ecmascript, Next.js server component, client modules)": ((__turbopack_context__) => {
...
//# sourceMappingURL=src_5ecca6._.js.map