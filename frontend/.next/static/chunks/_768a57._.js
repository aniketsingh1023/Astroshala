(globalThis.TURBOPACK = globalThis.TURBOPACK || []).push(["static/chunks/_768a57._.js", {
...
function AuthProvider({ children }) {
    ...
    const login = async (email, password)=>{
        ...
        setError(null);
        try {
            const response = await fetch(`${("TURBOPACK compile-time value", "http://localhost:5001")}/api/auth/login`, {
                method: 'POST',
                headers: {
    ...
    const checkBirthDetails = async ()=>{
        try {
            ...
            const response = await fetch(`${("TURBOPACK compile-time value", "http://localhost:5001")}/api/user/profile`, {
                headers: {
            ...
            const data = await response.json();
            const hasBirthDetails = !!(data.birth_details && data.birth_details.date && data.birth_details.time && data.birth_details.place);
...
//# sourceMappingURL=_768a57._.js.map